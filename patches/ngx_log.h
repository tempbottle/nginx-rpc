...
#define ngx_log_error(level, log, ...)                                        \
    if ((log)->log_level >= level)                                             \
        ngx_log_error_core((basename((char *)__FILE__)), __LINE__, level, log, __VA_ARGS__)

#define ngx_log_debug(level, log, ...)                                        \
    if ((log)->log_level & level)                                             \
        ngx_log_error_core((basename((char *)__FILE__)), __LINE__, NGX_LOG_DEBUG, log, __VA_ARGS__)
