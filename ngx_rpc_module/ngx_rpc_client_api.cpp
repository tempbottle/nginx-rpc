...
ngx_exec_new_binary(ngx_cycle_t *cycle, char *const *argv)
{
    ...
    *p = '\0';
    ...
    env[n++] = (char*)"SPARE=XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
...
ngx_core_module_init_conf(ngx_cycle_t *cycle, void *conf)
{
    ...
    if (ccf->cpu_affinity_n == 0) {
        ...
        if (ngx_ncpu > 0 && ngx_ncpu <= CPU_SETSIZE) {
            ...
            mask = (CPU_SET_T *)ngx_palloc(cycle->pool,
    ...
    if (lock_file.len) {
        ...
        cycle->lock_file.data = (u_char*)ngx_pnalloc(cycle->pool,
...
ngx_set_cpu_affinity(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (ngx_strcasecmp((u_char *) "auto", value[1].data) == 0) {
        ...
        ccf->cpu_affinity = (CPU_SET_T*)NGX_CONF_UNSET_PTR;
    ...
    mask = (CPU_SET_T        *)ngx_palloc(cf->pool, (cf->args->nelts - 1) * sizeof(CPU_SET_T));
    if (mask == NULL) {
        return (char*)NGX_CONF_ERROR;
    }
