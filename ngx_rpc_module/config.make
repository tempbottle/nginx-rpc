#this is bash shell script deprecated

#target
#libngx="$NGX_OBJS${ngx_dirsep}libnginx.a"


#1 deprecated rename main to _ngx_main in nginx.o , complie as ngx_main.o
...
#2 link the libngx
#libngx_objs=`echo ${ngx_objs} | sed  \
#                        -e "s|objs/src/core/nginx.o|$ngx_main_objs|" \
#                        -e "s/ \\\\\\ /$ngx_long_regex_cont/g"`

#cat << END                                                >> $NGX_MAKEFILE
#$libngx:	$ngx_objs$ngx_spacer
